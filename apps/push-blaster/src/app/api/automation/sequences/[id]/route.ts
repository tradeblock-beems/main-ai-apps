...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    const { sequenceExecutor, sequenceSafety, audienceProcessor } = await import('@/lib/sequenceExecutor');
...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    const { sequenceExecutor, sequenceSafety } = await import('@/lib/sequenceExecutor');
